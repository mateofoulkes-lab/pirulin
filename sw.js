const CACHE = 'pirulin-pwa-v0.14.3-beta';
const CORE = [
  './','./index.html','./mockup_pirulin_v51.html','./launcher-splash.js','./update-manager.js','./firebase-client.js',
